...
export async function getConfigAction(params: RequestValues, ctx: AtomicMarketContext): Promise<any> {
    ...
    const pairsQuery = await ctx.db.query(queryString, [ctx.core.args.atomicmarket_account]);
    ...
    return {
        ...
        atomicmarket_contract: ctx.core.args.atomicmarket_account,
        delphioracle_contract: ctx.core.args.delphioracle_account,
