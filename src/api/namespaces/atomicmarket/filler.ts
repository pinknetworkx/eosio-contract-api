...
export async function fillAuctions(connection: ConnectionManager, contract: string, auctions: any[]): Promise<any[]> {
    ...
    const filler = new AssetFiller(connection, contract, assetIDs, formatAsset, 'atomicassets_assets_master');
...
export async function fillSales(connection: ConnectionManager, contract: string, sales: any[]): Promise<any[]> {
    const assetIDs: string[] = [];
