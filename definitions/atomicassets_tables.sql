...
CREATE TABLE atomicassets_assets (
    ...
    readable_name character varying(64) NOT NULL,
...
CREATE INDEX atomicassets_assets_preset_id ON atomicassets_assets USING btree (preset_id);
CREATE INDEX atomicassets_assets_scheme_name ON atomicassets_assets USING btree (scheme_name);
CREATE INDEX atomicassets_assets_owner ON atomicassets_assets USING btree (owner);
...
CREATE INDEX atomicassets_assets_backed_tokens_token_symbol ON atomicassets_assets_backed_tokens USING btree (token_symbol);
...
CREATE INDEX atomicassets_assets_data_asset_id ON atomicassets_assets_data USING btree (contract, asset_id);
...
CREATE INDEX atomicassets_presets_collection_name ON atomicassets_presets USING btree (collection_name);
CREATE INDEX atomicassets_presets_scheme_name ON atomicassets_presets USING btree (scheme_name);
CREATE INDEX atomicassets_presets_created_at_block ON atomicassets_presets USING btree (created_at_block);
...
-- FOREIGN KEYS --
ALTER TABLE ONLY atomicassets_assets_backed_tokens
    ADD CONSTRAINT atomicassets_assets_backed_tokens_assets FOREIGN KEY (asset_id, contract) REFERENCES atomicassets_assets(asset_id, contract) ON UPDATE CASCADE ON DELETE RESTRICT NOT VALID;

ALTER TABLE ONLY atomicassets_assets_backed_tokens
    ADD CONSTRAINT atomicassets_assets_backed_tokens_symbol FOREIGN KEY (token_symbol, contract) REFERENCES atomicassets_token_symbols(token_symbol, contract) ON UPDATE CASCADE ON DELETE RESTRICT NOT VALID;

ALTER TABLE ONLY atomicassets_assets
    ADD CONSTRAINT atomicassets_assets_collections FOREIGN KEY (contract, collection_name) REFERENCES atomicassets_collections(contract, collection_name) ON UPDATE CASCADE ON DELETE RESTRICT NOT VALID;

ALTER TABLE ONLY atomicassets_assets_data
    ADD CONSTRAINT atomicassets_assets_data_assets FOREIGN KEY (asset_id, contract) REFERENCES atomicassets_assets(asset_id, contract) ON UPDATE CASCADE ON DELETE RESTRICT NOT VALID;
...
ALTER TABLE ONLY atomicassets_offers_assets
    ADD CONSTRAINT atomicassets_offers_assets_offers FOREIGN KEY (offer_id, contract) REFERENCES atomicassets_offers(offer_id, contract) ON UPDATE CASCADE ON DELETE RESTRICT NOT VALID;

ALTER TABLE ONLY atomicassets_presets
    ADD CONSTRAINT atomicassets_presets_collections FOREIGN KEY (collection_name, contract) REFERENCES atomicassets_collections(collection_name, contract) ON UPDATE CASCADE ON DELETE RESTRICT NOT VALID;
...
ALTER TABLE ONLY atomicassets_transfers_assets
    ADD CONSTRAINT atomicassets_transfers_assets_assets FOREIGN KEY (asset_id, contract) REFERENCES atomicassets_assets(asset_id, contract) ON UPDATE CASCADE ON DELETE RESTRICT;
