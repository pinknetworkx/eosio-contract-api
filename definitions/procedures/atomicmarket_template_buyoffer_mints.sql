CREATE OR REPLACE PROCEDURE update_atomicmarket_template_buyoffer_mints(selected_contract TEXT, last_irreversible_block BIGINT, max_buyoffers_to_update INT = 50000)
LANGUAGE plpgsql
AS $$
DECLARE
    r RECORD;
